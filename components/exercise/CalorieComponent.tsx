...
export default function CalorieComponent({
  ...
  return (
    <div className="flex lg:h-[250px] lg:min-w-min lg:max-w-xxs sm:w-[95%] sm:h-[150px] flex-col lg:self-start sm:self-center lg:justify-self-center overflow-hidden rounded-lg bg-gray-300 dark:bg-slate-500 shadow-lg lg:mt-8">
