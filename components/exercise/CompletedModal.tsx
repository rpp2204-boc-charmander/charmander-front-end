    ...
    <div>
      ...
      >
        <div className="header flex w-[100%] flex-row items-center justify-between pt-4 pb-4">
         ...
         <div className="bg-gray-500 dark:bg-gray-700 flex flex-col rounded-2xl h-[45%] w-full justify-around items-center overflow-y-scroll no-scrollbar shadow-[inset_0_2px_5px_0_#404040]">
          <div className="flex bg-slate-200 py-5 px-5 w-10/12 rounded-2xl justify-center">
            <h2 className="font-bold mr-3 text-black"> Actual Reps Completed: </h2>
            <input className="rounded-md shadow-md bg-slate-50 text-black" type="number" ref={actualRef}></input>
          </div>
         </div>

         <div className="flex w-full justify-between items-center mt-4 bg-gray-500 dark:bg-gray-700 rounded-full shadow-[inset_0_2px_5px_0_#404040]">
