  ...
  return (
    <div className="h-52 max-h-60 rounded-lg overflow-hidden shadow-lg bg-gray-200 mx-5 mt-8 p-4 flex justify-between">
      ...
      <div className="flex flex-col border-2">
        ...
        <h2 className="text-xl font-bold">{exercise.exercise}</h2>

        <p> Muscle Group: {exercise.muscle_group}</p>

        <p className=""> Estimated Calories Burned: {exercise.est_cals_burned}</p>
      ...
      <div className="border-gray-300 border-l-2 w-3/6 pl-5 relative flex flex-col justify-around">
        ...
        <button className="bg-green-500 text-slate-50 font-bold h-12 w-52 rounded-3xl hover:bg-green-400 self-center" onClick={toggleCompletedModal}> Completed </button>
      </div>
    </div>
  )
};