    ...
    <form className="container flex flex-row justify-between items-center bg-gray-300 p-5 w-[100%] mb-5 last:mb-0 h-[30rem]">
      ...
      <div className="flex flex-col">
        <div className="flex flex-col pb-3">
          <label className="flex text-sm font-bold pr-2 pb-1">Exercise</label>

          <input
            className="bg-white shadow appearance-none border rounded w-[10rem] py-2 px-3 leading-tight focus:outline-none focus:shadow-outline"
            name="name"
            type="text"
      ...
      <fieldset className="flex flex-row">
        ...
        <div className="pr-2">
          ...
          <input
            ...
            name="goals"
            value="same"
            className="shadow appearance-none border rounded w-[5rem] py-2 px-3 leading-tight focus:outline-none focus:shadow-outline h-10 bg-gray-400 checked:bg-yellow-400"
          ></input>
        </div>
        ...
        <div>
          <div className="flex flex-col h-[100%] justify-between">
            <div className="flex flex-row items-center justify-between pb-2">
              ...
              <input
                className="bg-white shadow appearance-none border rounded w-[5rem] py-2 px-3 leading-tight focus:outline-none focus:shadow-outline"
                name="weight"
                type="text"
                placeholder="Weight"
        ...
        <div className="flex flex-col items-center">
          <div>
            ...
            <select
              ...
              className="bg-white shadow border rounded w-[5rem] py-2 px-3 leading-tight"
            >
