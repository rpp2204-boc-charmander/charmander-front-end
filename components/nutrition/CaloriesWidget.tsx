...
const CaloriesWidget = ({handleShowModal, calories} : CaloriesProp) => {
  ...
  return (
    ...
    // </div>
    // </>
    <div className="max-w-xxs min-w-min max-h-calories overflow-hidden rounded-lg shadow-lg bg-gray-300 mt-8 flex flex-col justify-self-bottom text-black">
      <div className="h-4.5/6 rounded-lg bg-white shadow-inner m-3 flex flex-col justify-top items-center text-center overflow-hidden">
