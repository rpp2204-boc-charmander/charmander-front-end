...
const CaloriesWidget = ({handleShowModal, calories} : CaloriesProp) => {
  ...
  return (
    ...
    // </div>
    // </>
    <div className="m-6 max-w-xxs min-w-min max-h-calories overflow-hidden rounded-lg shadow-lg bg-gray-300 mt-8 flex flex-col justify-self-center text-black">
