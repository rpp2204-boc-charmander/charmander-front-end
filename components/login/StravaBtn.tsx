...
export default function StravaBtn() {
  ...
  const handleLogin = () => {
    ...
    // window.location = `http://www.strava.com/oauth/authorize?client_id=${id}&response_type=code&redirect_uri=${redirectUrl}/exchange_token&approval_prompt=force&scope=${scope}`;
